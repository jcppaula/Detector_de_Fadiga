...
while True:
    ...
    for rect in rects:
        ...
        # Verifica se o EAR está abaixo do limiar de piscar de olhos,
        ...
        # caso contrário, o EAR não está abaixo do limiar, então
        # reinicie o contador e o alarme
        else:
            CONTADOR = 0
            ALARME_ON = False

        # Desenha o valor do EAR no quadro
...
# Limpa a janela e fecha todas as janelas abertas
